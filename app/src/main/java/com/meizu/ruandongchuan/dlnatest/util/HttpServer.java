...
public class HttpServer
{
	...
	public Response serve( String uri, String method, Properties header, Properties parms, Properties files )
	{
		...
		if (uri.startsWith(ContentDirectory.CONTENT_EXPORT_URI)) {
			...
			Log.i(tag,"itemNode == null "+(itemNode == null));
			Log.i(tag,"itemNode instanceof FileItemNode ="+(itemNode instanceof FileItemNode));
			if (itemNode instanceof FileItemNode){
				FileItemNode fileItemNode = (FileItemNode) itemNode;
				fromUrl = fileItemNode.getFile().getPath();
			}
		...
		Log.i("fromUrl=", fromUrl);
		return serveFile( fromUrl, header, myRootDir, false );
	}
	...
	/**
	 * s a HTTP server to given port.<p>
